            ...
            ajouter.setOnClickListener(view1 -> {
                ...
                mAuth.createUserWithEmailAndPassword(emailText, password).addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(EtudiantsActivity.this, "L'étudiant(e)' "+name+" a été bien créé.", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(EtudiantsActivity.this, "Création échouée.", Toast.LENGTH_SHORT).show();
                    }
                });
            });
            dialog.show();
